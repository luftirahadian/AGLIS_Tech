  ...
  async updateSettings(userId, settings) {
    ...
    const result = await pool.query(
      `INSERT INTO notification_settings_advanced (
        user_id, web_notifications, mobile_push, email_notifications, sms_notifications, whatsapp_notifications,
      ...
      ON CONFLICT (user_id) DO UPDATE SET
        ...
        whatsapp_notifications = COALESCE($6, notification_settings_advanced.whatsapp_notifications),
        quiet_hours_enabled = COALESCE($7, notification_settings_advanced.quiet_hours_enabled),
        quiet_hours_start = COALESCE($8, notification_settings_advanced.quiet_hours_start),
        quiet_hours_end = COALESCE($9, notification_settings_advanced.quiet_hours_end),
        quiet_hours_timezone = COALESCE($10, notification_settings_advanced.quiet_hours_timezone),
        dnd_enabled = COALESCE($11, notification_settings_advanced.dnd_enabled),
        dnd_until = COALESCE($12, notification_settings_advanced.dnd_until),
        batch_notifications = COALESCE($13, notification_settings_advanced.batch_notifications),
        batch_interval = COALESCE($14, notification_settings_advanced.batch_interval),
        show_low_priority = COALESCE($15, notification_settings_advanced.show_low_priority),
        show_normal_priority = COALESCE($16, notification_settings_advanced.show_normal_priority),
        show_high_priority = COALESCE($17, notification_settings_advanced.show_high_priority),
        show_urgent_priority = COALESCE($18, notification_settings_advanced.show_urgent_priority),
        type_settings = COALESCE($19, notification_settings_advanced.type_settings),
        group_by_type = COALESCE($20, notification_settings_advanced.group_by_type),
        group_by_priority = COALESCE($21, notification_settings_advanced.group_by_priority),
        auto_archive_after_days = COALESCE($22, notification_settings_advanced.auto_archive_after_days),
        auto_delete_after_days = COALESCE($23, notification_settings_advanced.auto_delete_after_days),
        daily_digest = COALESCE($24, notification_settings_advanced.daily_digest),
        weekly_digest = COALESCE($25, notification_settings_advanced.weekly_digest),
        digest_time = COALESCE($26, notification_settings_advanced.digest_time),
        updated_at = CURRENT_TIMESTAMP
      RETURNING *`,
      [
        userId, web_notifications, mobile_push, email_notifications, sms_notifications, whatsapp_notifications,
        quiet_hours_enabled, quiet_hours_start, quiet_hours_end, quiet_hours_timezone,
        dnd_enabled, dnd_until, batch_notifications, batch_interval,
        show_low_priority, show_normal_priority, show_high_priority, show_urgent_priority,
